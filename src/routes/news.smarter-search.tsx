...
/* =============================================================================
   News article: Smarter search rolls out to all users
...
export const Route = createFileRoute("/news/smarter-search")({
  head: () => ({
    ...
    scripts: [{
      ...
      children: "{\"@context\":\"https://schema.org\",\"@type\":\"NewsArticle\",\"headline\":\"Smarter search rolls out to all users\",\"description\":\"A redesigned discovery engine helps buyers find exactly what they want.\",\"image\":[\"https://market360-web.lovable.app/brand/news-search.jpg\"],\"datePublished\":\"May 22, 2026\",\"dateModified\":\"May 22, 2026\",\"author\":{\"@type\":\"Organization\",\"name\":\"Product\"},\"publisher\":{\"@type\":\"Organization\",\"name\":\"Market360\",\"logo\":{\"@type\":\"ImageObject\",\"url\":\"https://market360-web.lovable.app/brand/market360-logo.png\"}},\"mainEntityOfPage\":{\"@type\":\"WebPage\",\"@id\":\"https://market360-web.lovable.app/news/smarter-search\"},\"articleSection\":\"Update\"}",
    }],
  }),
  component: Article,
});
...
function Article() {
  ...
  return (
    <SiteLayout>
      ...
      <p className="mt-4 text-base text-muted-foreground leading-relaxed">Search now understands what you mean, not just what you type. Whether you spell it &#39;kafutay&#39; or &#39;kaftan&#39;, Market360 will surface the right results.</p>
      <h2 className="text-2xl font-bold mt-10 mb-3">Under the hood</h2>
      <p className="mt-4 text-base text-muted-foreground leading-relaxed">We&#39;ve added typo tolerance, synonym expansion for local terms, and a relevance model trained on millions of real Sierra Leone queries. Filters are faster, and category suggestions appear as you type.</p>
            </div>
