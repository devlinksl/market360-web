...
const TITLE = "New fraud protection layer goes live";
const EXCERPT = "Our updated AI model flags risky activity in real-time.";
const IMAGE = "/brand/news-fraud.jpg";
const CATEGORY = "Trust";
const AUTHOR = "Trust & Safety";
const DATE = "Apr 28, 2026";
        ...
        <div className="container-pro -mt-24 relative pb-16">
          <div className="surface-card p-8 md:p-12 max-w-3xl mx-auto">
            ...
            <div className="mt-8 space-y-6 text-base text-muted-foreground leading-relaxed">
              <p>We've deployed a new fraud-detection model that scores every transaction in milliseconds — blocking suspicious activity before money moves.</p>

              <h2 className="text-2xl font-bold text-foreground mt-8">What's new</h2>
              <p>The model evaluates dozens of behavioural signals: device fingerprint, location consistency, account age, and unusual purchase patterns. Combined, they catch roughly 98% of fraud attempts in the test set with under 0.2% false positives.</p>
            </div>

            <div className="mt-12 flex flex-wrap gap-3">
              <Link to="/safety" className="btn-primary">Marketplace safety <ArrowRight className="h-4 w-4" /></Link>
