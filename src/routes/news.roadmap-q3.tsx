...
/* =============================================================================
   News article: What's coming this quarter
...
export const Route = createFileRoute("/news/roadmap-q3")({
  head: () => ({
    ...
    scripts: [{
      ...
      children: "{\"@context\":\"https://schema.org\",\"@type\":\"NewsArticle\",\"headline\":\"What's coming this quarter\",\"description\":\"Storefronts, bulk uploads, smarter analytics, and more.\",\"image\":[\"https://market360-web.lovable.app/brand/news-roadmap.jpg\"],\"datePublished\":\"May 10, 2026\",\"dateModified\":\"May 10, 2026\",\"author\":{\"@type\":\"Organization\",\"name\":\"Market360 Team\"},\"publisher\":{\"@type\":\"Organization\",\"name\":\"Market360\",\"logo\":{\"@type\":\"ImageObject\",\"url\":\"https://market360-web.lovable.app/brand/market360-logo.png\"}},\"mainEntityOfPage\":{\"@type\":\"WebPage\",\"@id\":\"https://market360-web.lovable.app/news/roadmap-q3\"},\"articleSection\":\"Roadmap\"}",
    }],
  }),
  component: Article,
});
...
function Article() {
  ...
  return (
    <SiteLayout>
      ...
      <p className="mt-4 text-base text-muted-foreground leading-relaxed">Here&#39;s a peek at what the team is building over the next three months.</p>
      <h2 className="text-2xl font-bold mt-10 mb-3">Storefront 2.0</h2>
      <p className="mt-4 text-base text-muted-foreground leading-relaxed">Branded storefronts with custom banners, featured collections, and shareable links that work great on WhatsApp and Instagram.</p>
      <h2 className="text-2xl font-bold mt-10 mb-3">Bulk product upload</h2>
      <p className="mt-4 text-base text-muted-foreground leading-relaxed">Upload hundreds of products at once with a CSV or spreadsheet. Ideal for established sellers migrating their catalogue.</p>
      <h2 className="text-2xl font-bold mt-10 mb-3">Analytics deep-dives</h2>
      <p className="mt-4 text-base text-muted-foreground leading-relaxed">Cohort analysis, repeat-buyer tracking, and per-product profit margins — surfaced inside the seller dashboard.</p>
            </div>
