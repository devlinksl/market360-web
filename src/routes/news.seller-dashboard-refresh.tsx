...
/* =============================================================================
   News article: Seller dashboard gets a refresh
...
export const Route = createFileRoute("/news/seller-dashboard-refresh")({
  head: () => ({
    ...
    scripts: [{
      ...
      children: "{\"@context\":\"https://schema.org\",\"@type\":\"NewsArticle\",\"headline\":\"Seller dashboard gets a refresh\",\"description\":\"Cleaner layout, faster insights, smoother workflows.\",\"image\":[\"https://market360-web.lovable.app/brand/news-dashboard.jpg\"],\"datePublished\":\"Apr 02, 2026\",\"dateModified\":\"Apr 02, 2026\",\"author\":{\"@type\":\"Organization\",\"name\":\"Design\"},\"publisher\":{\"@type\":\"Organization\",\"name\":\"Market360\",\"logo\":{\"@type\":\"ImageObject\",\"url\":\"https://market360-web.lovable.app/brand/market360-logo.png\"}},\"mainEntityOfPage\":{\"@type\":\"WebPage\",\"@id\":\"https://market360-web.lovable.app/news/seller-dashboard-refresh\"},\"articleSection\":\"Product\"}",
    }],
  }),
  component: Article,
});
...
function Article() {
  ...
  return (
    <SiteLayout>
      ...
      <p className="mt-4 text-base text-muted-foreground leading-relaxed">The seller dashboard just got a major design refresh — focused on speed, clarity, and the workflows sellers tell us they touch most often.</p>
      <h2 className="text-2xl font-bold mt-10 mb-3">Top changes</h2>
      <p className="mt-4 text-base text-muted-foreground leading-relaxed">A new sticky sidebar, a redesigned overview with live KPIs, faster order management, and a 40% reduction in time-to-first-paint on mid-range Android devices.</p>
            </div>
