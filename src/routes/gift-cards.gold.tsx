...
const card = getGiftCard("gold");
const TITLE = `Market360 Gold E-Gift Card — ${card.price}`;
const URL = "https://market360.shop/gift-cards/gold";

export const Route = createFileRoute("/gift-cards/gold")({
  head: () => ({
    meta: [
      { title: TITLE },
    ...
    scripts: [{ type: "application/ld+json", children: JSON.stringify(giftCardSchema("gold")) }],
  }),
  component: () => <GiftCardDetail slug="gold" />,
});
