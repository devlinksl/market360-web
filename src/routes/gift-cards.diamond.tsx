...
const card = getGiftCard("diamond");
const TITLE = `Market360 Diamond E-Gift Card — ${card.price}`;
const URL = "https://market360.shop/gift-cards/diamond";

export const Route = createFileRoute("/gift-cards/diamond")({
  head: () => ({
    meta: [
      { title: TITLE },
    ...
    scripts: [{ type: "application/ld+json", children: JSON.stringify(giftCardSchema("diamond")) }],
  }),
  component: () => <GiftCardDetail slug="diamond" />,
});
