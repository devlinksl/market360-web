...
/* =============================================================================
   News article: Market360 opens its public tester program
...
export const Route = createFileRoute("/news/tester-program-launch")({
  head: () => ({
    ...
    scripts: [{
      ...
      children: "{\"@context\":\"https://schema.org\",\"@type\":\"NewsArticle\",\"headline\":\"Market360 opens its public tester program\",\"description\":\"We're inviting the community to help shape the next era of Market360 — with early access, perks, and direct influence on the roadmap.\",\"image\":[\"https://market360-web.lovable.app/brand/news-tester-launch.jpg\"],\"datePublished\":\"Jun 12, 2026\",\"dateModified\":\"Jun 12, 2026\",\"author\":{\"@type\":\"Organization\",\"name\":\"Market360 Team\"},\"publisher\":{\"@type\":\"Organization\",\"name\":\"Market360\",\"logo\":{\"@type\":\"ImageObject\",\"url\":\"https://market360-web.lovable.app/brand/market360-logo.png\"}},\"mainEntityOfPage\":{\"@type\":\"WebPage\",\"@id\":\"https://market360-web.lovable.app/news/tester-program-launch\"},\"articleSection\":\"Announcement\"}",
    }],
  }),
  component: Article,
});
...
function Article() {
  ...
  return (
    <SiteLayout>
      ...
      <p className="mt-4 text-base text-muted-foreground leading-relaxed">Today we&#39;re opening up the Market360 Tester Program to the public. After months of running it privately with a small group of sellers and power-buyers, we&#39;re ready to invite anyone in Sierra Leone who wants to help shape what comes next.</p>
      <h2 className="text-2xl font-bold mt-10 mb-3">Why we're doing this</h2>
      <p className="mt-4 text-base text-muted-foreground leading-relaxed">The best products are built with the people who use them. Our private testers caught dozens of bugs, suggested the redesigned checkout flow, and helped us prioritise wallet improvements over flashier features. Opening the program means we can capture even more of that wisdom.</p>
      <h2 className="text-2xl font-bold mt-10 mb-3">What testers get</h2>
      <p className="mt-4 text-base text-muted-foreground leading-relaxed">Early access to every feature, a private community to talk directly with the product team, wallet credit when bugs are reproduced, and an exclusive tester badge on your profile. It&#39;s our way of saying thank you for the work you put in.</p>
      <h2 className="text-2xl font-bold mt-10 mb-3">How to join</h2>
      <p className="mt-4 text-base text-muted-foreground leading-relaxed">Head to the Tester Program page, enter your name and email, and we&#39;ll send an invite link the same day. There&#39;s no commitment — leave the program any time from settings.</p>
            </div>
